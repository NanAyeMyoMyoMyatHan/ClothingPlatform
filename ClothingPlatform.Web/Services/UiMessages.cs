namespace ClothingPlatform.Web.Services
{
    internal static class UiMessages
    {
        internal static class Admin
        {
            ...
            public static string OrderCancelled(int orderId) => $"Order ORD-{orderId:D4} was cancelled.";
            public static string OrderCancelFailed(string detail) => $"Admin order cancellation failed. {detail}";
            public const string CreateProductCategoryRequired = "Choose a category before creating this product.";
            public const string CreateProductRequiredFields = "New product needs a name before you add its variants.";
            ...
            public const string UpdateProductRequiredFields = "Product update needs a name before you save its variants.";
